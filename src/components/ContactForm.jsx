    ...
    >
      ...
      <div className="sm:col-span-2">
        <button
          ...
          className="w-full rounded-md bg-emerald-800 px-5 py-3 text-sm font-medium text-white hover:bg-emerald-900 disabled:cursor-not-allowed disabled:opacity-50 sm:w-auto"
        >
          Nachricht senden
        </button>
      </div>
