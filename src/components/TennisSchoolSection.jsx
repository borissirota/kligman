            ...
            <figcaption className="border-t border-neutral-100 px-4 py-4">
              ...
              {leadTrainer.licenseUrl ? (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-3 inline-flex rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-xs font-medium text-emerald-900 transition hover:bg-emerald-100"
                >
